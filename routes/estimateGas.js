...
import { getNetworkRpcByKey, getTokenDecimals } from "../utils/networkHelper.js"; // <-- ASUMSIKAN getTokenDecimals DITAMBAH
 ...
 * to: "0x....", 
 * tokenAddress: "0x...", 
 * amount: "1.0" // <-- SEKARANG DALAM FORMAT DESIMAL/STRING MUDAH BACA
 * }
 */
router.get("/", async (req, res) => {
    try {
        ...
        if (tokenAddress && amount) {
            ...
            if (decimals === null) {
                 return res.status(400).json({ error: `Could not determine decimals for token ${tokenAddress}` });
            }
